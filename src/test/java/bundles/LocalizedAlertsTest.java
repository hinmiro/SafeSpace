...
public class LocalizedAlertsTest {
    ...
    public void testAlertsFinnish() {
        ...
        String[] expectedValues = {
                ...
                "Virhe", "Uusi viesti lähetettiin onnistuneesti!", "Viestin lähettämisessä tapahtui virhe.",
                "Lisää kuva viestiisi.", "Tiedot", "Kirjoita jotain ennen julkaisua.", "Tiedot päivitetty",
